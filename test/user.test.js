...
test('should be able to send device token / Success Case', () => {
...
// describe('Verify User / Error Case', () => {
//     test('failed due to invalid OTP', (done) => {
//         const false_OTP = {
//             phone: '+62811371104',
//             code: 264870,
//             deviceId: 'blublub1234'
...
//             })
//     })
//     test('failed due wrong body of request', (done) => {
//         const false_phone_format = ['Not this']
//         request(app)
//             .post('/verify')
//             .send({...phone_verify, phone: false_phone_format})
//             .end((err, res) => {
//                 if(err) throw err
//                 expect(res.status).toBe(500)
//                 expect(res.body).toHaveProperty('errors', expect.any(Array))
